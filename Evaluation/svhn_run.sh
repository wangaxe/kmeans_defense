...
# python svhn_eva.py --defense km --attack-type deepfool --iter 100 --model pr18 --fname deepfool --k 4
# python svhn_eva.py --defense km --attack-type deepfool --iter 100 --model pr18 --fname deepfool --k 5
